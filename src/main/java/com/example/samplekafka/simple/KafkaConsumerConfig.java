...
public class KafkaConsumerConfig {
    ...
    private ConcurrentKafkaListenerContainerFactory concurrentKafkaListenerContainerFactory(String groupId) {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> firstListenerContainerFactory() {
        return concurrentKafkaListenerContainerFactory("first");
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, String> secondListenerContainerFactory() {
        return concurrentKafkaListenerContainerFactory("second");
    }
